# 옆 시스템과의 통신 — 배정 정책(L1)과 공간 소유자(L3)
...
- **옆 시스템은 위에 있지 않습니다.** 상류(MES·WMS)의 `JobOrder` 는 본 계층으로 들어옵니다. L1 은 본 계층에 순위를 제안하는 상대이지 작업을 내리는 상위가 아닙니다.
...
> 마지막 대조: 2026-09-25 · sha256:d563e2e4435f · 열림: §15.154, §15.162
