...
| 판 | `schemaVersion` 이 `3` 입니다. `2` 에서 `blockedBy` 가 분류 이름의 배열에서 결함 객체의 배열로 **모양이 바뀌었으므로** 그 판은 읽는 쪽이 보아야 하며, `3` 은 칸이 는 것뿐입니다 |
...
> 마지막 대조: 2026-09-20 · sha256:b071c6164f90 · 열림: §15.143, §15.154, §15.162, §15.163, §15.3, §15.166, §15.173, §15.174, §15.175, §15.176, §15.178
