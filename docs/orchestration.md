...
**요청하는 쪽의 계약은 따로 적었습니다.** 위 표는 본 저장소가 **구간 소유자일 때** 내놓을 관문입니다. 본 저장소가 걷는 기체를 대신해 **다른 소유자에게 요청하는** 쪽의 메시지·순서·실패 처리와, 배정 정책(L1)과 주고받는 것은 [옆 시스템과의 통신](superpowers/specs/2026-09-25-peer-systems-dispatch-and-space-design.md)이 정합니다. 소유자가 누구로 정해지든 그 계약은 같습니다.
...
> 마지막 대조: 2026-09-25 · sha256:41fac9957f20 · 열림: §15.143, §15.154, §15.162, §15.163, §15.3, §15.166, §15.173, §15.174, §15.175, §15.176, §15.178, §15.183, §15.184
