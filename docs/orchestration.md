...
| 조치의 자동 승인 권한 | 현장 — 선언하는 사람 (ADR 43) | `Middleware.approveRemedy` → `entitlementRefusal` — 선언에 없는 에이전트 승인을 거절. 사람은 선언을 안 본다 | 있음 (§15.3 — 신원은 위조 가능하며 부인방지가 아니라 조사 단서다) |
...
**파일로 쓰는 쪽은 시나리오 구동기입니다.** v1 에서 그것은 시험이며, 한 벌은 `picasso/build/export/` 에 나옵니다. 따라서 **시험을 돌려야 한 벌이 갱신됩니다** — C 를 고른 대가이고, 승격하면 그 제약이 사라집니다.
...
> 마지막 대조: 2026-09-18 · sha256:16fe260446f8 · 열림: §15.143, §15.154, §15.162, §15.163, §15.3, §15.166
