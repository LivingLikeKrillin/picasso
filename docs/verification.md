...
본 문서는 `picasso` 미들웨어 시스템의 1,820개 자동화 테스트가 **어느 구간에서 실제 외부 시스템/하드웨어와 연동되고, 어느 구간에서 모의 대역(Mock/In-process)에 의존하는지**를 명확히 구분하여 기술적 검증 신뢰도(Verification Fidelity)를 투명하게 공개하기 위해 작성되었습니다.
...
> 마지막 대조: 2026-09-23 · sha256:94f96aa81a44 · 열림: C-3, §15.125
